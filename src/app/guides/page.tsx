...
export const metadata: Metadata = {
  title: 'New York Travel Guides 2026 | Tips, Itineraries & Insider Advice',
  description: 'Expert New York travel guides covering first-time tips, one-day itineraries, free things to do, food tours, seasonal advice, and day trip ideas.',
  alternates: { canonical: `${SITE_URL}/guides` },
  openGraph: {
    title: 'New York Travel Guides 2026',
    description: 'Expert New York travel guides covering first-time tips, one-day itineraries, free things to do, and more.',
    url: `${SITE_URL}/guides`,
  },
};
...
export default function GuidesPage() {
  return (
    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8">
        <h1 className="text-3xl sm:text-4xl font-bold text-gray-900">New York Travel Guides</h1>
        <p className="mt-3 text-lg text-gray-600 max-w-3xl">
          Expert tips, itineraries, and insider advice to help you plan the perfect New York trip.
        </p>
      </div>
