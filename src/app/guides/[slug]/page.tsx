      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-8">
        ...
        <article>
          <header className="mb-10">
            ...
            {guide.answerCapsule && (
              <div className="mt-4 rounded-xl border border-green-200 bg-green-50 p-5">
                <DisplayCopy as="p" className="text-base text-gray-800 leading-relaxed" text={guide.answerCapsule} />
              </div>
            )}
          ...
          <div className="mt-12 rounded-xl bg-gradient-to-r from-green-700 to-emerald-800 p-5 sm:p-6 text-center text-white">
            ...
            <p className="text-sm text-green-100 mb-4">Browse all New York tours and filter by type, price, and duration. Free cancellation on most.</p>
          ...
          {(() => {
            ...
            return otherGuides.length > 0 ? (
              <section className="mt-12 bg-gray-50 rounded-xl p-6">
                <h2 className="text-xl font-bold text-gray-900 mb-4">More New York Guides</h2>
