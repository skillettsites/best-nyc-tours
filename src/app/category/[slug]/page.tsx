...
const categorySeoContent: Record<string, { paragraphs: string[]; relatedGuides: { href: string; title: string }[] }> = {
  ...
  'food-drink': {
    paragraphs: [
      'New York food tours divide neatly into walking tours and floating ones. The walks put you in one neighbourhood and feed you through it, which is why the Chinatown and Little Italy tour from £63 rates so well: two of the most distinctive eating districts in Manhattan sit directly beside each other, so a single lunchtime walk covers dumplings, bakery counters and old Italian delis without a subway ride in between. Go hungry and skip breakfast.',
  ...
  'guided-tours': {
    paragraphs: [
      'A guided tour earns its price in New York when it takes you somewhere you would not confidently go alone, or explains something you could not read off a plaque. The Contrasts tour of Harlem, the Bronx, Queens and Brooklyn from £30 is the clearest example on this page. Most first-time visitors never leave Manhattan, and a guide who lives in those boroughs turns a bus ride into the most memorable half-day of the trip.',
      ...
      'The big day trips are the other reason to book a guide. Washington DC from £81 and Niagara Falls from £121 are both long days with a lot of driving, and the value is in someone else handling the logistics. On the water, the Sunset and Harbor Lights cruise from £34 pairs golden hour with the skyline, and the Statue of Liberty and Ellis Island guided tour with ferry from £37 adds a live guide to the island landing, which is worth the premium if the immigration history is your reason for going.',
    ],
    relatedGuides: [
      { href: '/guides/best-guided-tours-in-new-york', title: 'Best Guided Tours in New York' },
  ...
  'top-attractions': {
    paragraphs: [
      ...
      'Beyond the pass, the highest-rated experiences here are not the obvious ones. A Harlem gospel concert from £15 rates as highly as attractions costing five times more, MJ the Musical on Broadway from £54 is the best-reviewed show in the list, though that ticket alone is non-refundable, and a Brooklyn graffiti workshop with a local artist from £30 is the rare New York activity where you make something rather than look at it.',
      'Whatever you pick, book the timed slot before you travel rather than on the day. The classic sights run on reserved entry, the sunset and evening slots go first, and most options here include free cancellation up to 24 hours before, so an early booking costs you nothing but secures the time you actually want. The exception is MJ the Musical, which is non-refundable, so fix that date before you pay.',
    ],
    relatedGuides: [
      { href: '/blog/is-the-new-york-citypass-worth-it', title: 'Is the New York CityPASS Worth It?' },
