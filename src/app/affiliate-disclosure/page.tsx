...
export const metadata: Metadata = {
  ...
  description: 'Learn how Best New York Tours earns revenue through affiliate partnerships with GetYourGuide and other booking platforms, and how this affects your experience.',
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="prose max-w-none text-gray-700 leading-relaxed space-y-6">
        ...
        <p>
          Best New York Tours (best-nyc-tours.com) is a free travel guide that earns revenue through
        ...
        <p>
          ...
          honest assessment of the best experiences available in New York.
        </p>
        <p>
