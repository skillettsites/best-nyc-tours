...
export const metadata: Metadata = {
  ...
  description: 'Privacy policy for Best New York Tours. Learn how we collect, use, and protect your data.',
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="prose max-w-none text-gray-700 leading-relaxed space-y-6">
        ...
        <p>
          Best New York Tours (best-nyc-tours.com) is operated by Skillett Sites. Our website helps visitors
          find and book tours and attractions in New York through affiliate partnerships with booking providers.
        </p>
