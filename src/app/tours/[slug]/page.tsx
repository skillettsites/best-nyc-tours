...
const categoryGuideMap: Record<string, string[]> = {
  landmarks: ['first-time-visiting-nyc', 'nyc-3-day-itinerary', 'best-walking-tours-nyc-2026'],
  'river-cruises': ['bus-tour-vs-boat-tour-nyc', 'nyc-tours-for-couples', 'nyc-3-day-itinerary'],
  'day-trips': ['best-day-trips-from-nyc', 'first-time-visiting-nyc', 'nyc-3-day-itinerary'],
  'food-tours': ['nyc-food-tours', 'free-things-to-do-in-nyc-2026'],
  'family-fun': ['best-nyc-tours-for-kids', 'nyc-rainy-day-activities', 'free-things-to-do-in-nyc-2026'],
  'walking-tours': ['best-walking-tours-nyc-2026', 'first-time-visiting-nyc', 'free-things-to-do-in-nyc-2026'],
  'museums-exhibitions': ['nyc-rainy-day-activities', 'first-time-visiting-nyc', 'best-nyc-tours-for-kids'],
  'evening-experiences': ['nyc-tours-for-couples', 'best-walking-tours-nyc-2026', 'best-evening-tours-nyc-2026'],
};
...
export default async function TourPage({ params }: { params: Params }) {
  ...
  // "Or book instead", destination's top converter (New York for BLT)
  const topConverter = TOP_CONVERTER_BY_DESTINATION.nyc;
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6 pb-28 lg:pb-12">
        ...
        {tour.categories.length > 0 && (
          <section className="mt-16">
            <SectionHeader title="Browse more New York tours" />
            <div className="flex flex-wrap gap-2">
        ...
        {(() => {
          ...
          return (
            <section className="mt-16 rounded-card-lg bg-surface-muted p-6 sm:p-8">
              <h2 className="text-xl font-semibold text-on-surface mb-4">More New York guides</h2>
