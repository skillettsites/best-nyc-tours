...
export default async function OGImage({ params }: { params: Params }) {
  ...
  if (!tour) {
    return new ImageResponse(
      (<div style={{ width: '100%', height: '100%', background: '#1e3a5f', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontSize: 48, fontFamily: 'Geist' }}>Best New York Tours</div>),
