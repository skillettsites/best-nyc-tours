...
export const metadata: Metadata = {
  title: 'All New York Tours & Attractions 2026 | Book Online',
  ...
  openGraph: {
    title: 'All New York Tours & Attractions 2026',
    description: 'Browse and book the best New York tours and attractions. Best prices, instant confirmation.',
    url: `${SITE_URL}/tours`,
  },
};
  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-900">All New York Tours & Attractions</h1>
          <p className="mt-3 text-lg text-gray-600 max-w-3xl">
            Discover {tours.length} hand-picked tours and attractions in New York. Book online for the best prices and skip-the-line entry.
          </p>
        ...
        <section className="mt-12 bg-gray-50 rounded-xl p-6">
          <h2 className="text-xl font-bold text-gray-900 mb-4">New York Travel Guides</h2>
          <p className="text-gray-600 mb-4">Not sure where to start? Our guides help you plan the perfect New York trip.</p>
