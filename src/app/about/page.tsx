...
export const metadata: Metadata = {
  title: 'About Us',
  description: 'Best New York Tours helps visitors find and book the best tours, attractions, and experiences in New York. Learn more about who we are and what we do.',
...
export default function AboutPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-8">
      ...
      <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">About Best New York Tours</h1>

      <div className="prose max-w-none text-gray-700 leading-relaxed space-y-6">
        <p>
          Best New York Tours is your trusted guide to the best tours, attractions, and experiences in New York.
        ...
        <p>
          New York is one of the most visited cities in the world, with thousands of tours and attractions
        ...
        <p>
          Whether you are visiting New York for the first time or looking for something new, our curated
        ...
        <p>
          ...
          <a href="mailto:contact@best-nyc-tours.com" className="text-blue-900 hover:underline">
            contact@best-nyc-tours.com
          </a>.
        </p>
      </div>
