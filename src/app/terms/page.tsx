...
export const metadata: Metadata = {
  title: 'Terms of Use',
  description: 'Terms of use for Best New York Tours. Read our terms and conditions for using the website.',
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="prose max-w-none text-gray-700 leading-relaxed space-y-6">
        ...
        <p>
          Best New York Tours (best-nyc-tours.com) is an affiliate website that recommends tours and
          attractions in New York. We do not sell tickets directly. When you click a booking link on our
