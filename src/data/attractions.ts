...
export const attractions: Attraction[] = [
    ...
    bodySections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Edge at Hudson Yards from £36 is the highest outdoor sky deck in the Western Hemisphere and leans into the sensation of height, with a glass floor panel and walls that angle outward. It faces west and south, which is dramatic but points away from Midtown\'s most famous towers. SUMMIT One Vanderbilt from £36 is the strangest of the three, a mirrored immersive art environment beside Grand Central that multiplies the skyline in every direction. Choose Top of the Rock for the photograph, Edge for the adrenaline, SUMMIT for the experience.',
        ],
      },
    ],
    relatedGuides: [
  ...
  },
  {
    ...
    metaDescription: 'Edge at Hudson Yards tickets in New York from £36. Timed entry to the highest outdoor sky deck in the Western Hemisphere, with free cancellation on most options.',
    ...
    answerCapsule: 'Edge at Hudson Yards tickets start at £36 for timed entry, rated 4.6 stars by more than 22,000 travellers. It is the highest outdoor sky deck in the Western Hemisphere, with a glass floor panel and walls that angle outward over the street. Book it for the sensation of height rather than the classic Midtown photograph, and skip it if vertigo is a problem.',
    ...
    faqs: [
      { question: 'How much are Edge Observation Deck tickets?', answer: 'Edge tickets in New York start from around £36 for timed entry to the Hudson Yards sky deck. The ranked list shows current prices and availability.' },
      { question: 'What is the best Edge Observation Deck ticket?', answer: 'The top-rated option is NYC: Edge Immersive Observation Deck Ticket, rated 4.6 stars by 22,519 travellers, from £36.' },
