...
export const categories: Category[] = [
  {
    ...
    icon: '🎟️',
    tourSlugs: ['nyc-summit-one-vanderbilt-tickets', '911-memorial-museum-admission-skip-the-ticket-line', 'nyc-edge-immersive-observation-deck-ticket', 'statue-of-liberty-ellis-island-ticket-options-with-ferry', 'new-york-citypassr-save-up-to-41-at-5-top-attractions', 'nyc-manhattan-sightseeing-helicopter-tour'],
    faqs: [
  ...
  },
  {
    ...
    icon: '⭐',
    tourSlugs: ['new-york-citypassr-save-up-to-41-at-5-top-attractions', 'nyc-mj-the-musical-on-broadway', 'ny-contrasts-brooklyn-bronx-harlem-queens-coney-island'],
    faqs: [
