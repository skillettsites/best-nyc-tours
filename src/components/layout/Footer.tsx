          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="sm:col-span-2 lg:col-span-1">
              ...
              <div className="space-y-1.5">
                {['Free cancellation on most tours', 'Best price guaranteed', 'Instant booking confirmation'].map((t) => (
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link href="/best-time-to-visit-new-york" className="text-sm hover:text-white transition-colors inline-flex items-center min-h-[32px]">Best Time to Visit</Link></li>
