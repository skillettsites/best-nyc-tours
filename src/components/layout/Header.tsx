          ...
          <div className="flex h-14 sm:h-16 items-center justify-between gap-4">
            ...
            <Link href="/" className="flex items-center shrink-0">
              <span className="text-base sm:text-lg font-bold text-[#1e3a5f] leading-tight">
                <span className="hidden sm:inline">Best New York Tours</span>
                <span className="sm:hidden">New York</span>
              </span>
            </Link>
        ...
        >
          ...
          <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
            <Link href="/" className="flex items-center" onClick={() => setDrawerOpen(false)}>
              <span className="text-base font-bold text-[#1e3a5f]">Best New York Tours</span>
            </Link>
            <button
              onClick={() => setDrawerOpen(false)}
